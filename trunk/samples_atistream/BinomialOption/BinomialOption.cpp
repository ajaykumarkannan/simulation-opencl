...
BinomialOption::setupCL()
{
    ...
    /* Create memory objects for stock price */
    ...
    /* Create memory objects for output array */
    ...
    kernelFile.open("BinomialOption_Kernels.cl");
...
void BinomialOption::printStats()
{
    ...
    stats[2] = sampleCommon->toString(numSamples/totalTime, std::dec);
